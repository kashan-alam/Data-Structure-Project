...
//	}
//
//	void price_lh(node *current) {
//		if (current == NULL) {
//			return;
//		}
//		price_lh(current->lchild);
//		price.push(current);
//		price_lh(current->rchild);
//	} 
//
//	void title_lh(node* current) {
//		if (current == NULL) {
//			return;
//		}
//		title_lh(current->lchild);
//		title.push(current);
//		title_lh(current->rchild);
//	}
//
//	void print_price_lh() {
//		node* current;
...
//	}
//
//	void insert_price(string t, string a, int p,int s) { //BST for book information according to price from high to low
...
//	}
//
//	void insert_title(string t, string a, int p,int s) { //BST for book information according to title from high to low
//		node* new_node = new node(t, a, p,s);
//		if (root_title == NULL) {
//			root_title = new_node;
//			return;
...
//	cout << "1. View Book Listing\n";
//	cout << "2. Search for a Book\n";
//	cout << "3. View Shopping Cart\n";
//	cout << "4. Checkout\n";
//	//cout<<	6. Log In / Create Account
...
//
//	book b;
//	b.insert_price("hpagof", "jk rowling", 2500,2);
//	b.insert_price("gulliver traverls", "jonathon swift", 1800,2);
//	b.insert_price("hpahbp", "JK rowling", 2220,4);
//	b.inorder(b.root_price);
//	cout << endl;
//	b.insert_title("hpagof", "jk rowling", 2500,2);
//	b.insert_title("gulliver travels", "jonathon swift", 1800,2);
//	b.insert_title("hpahbp", "JK rowling", 2220,4);
//	b.inorder(b.root_title);
//	b.price_lh(b.root_price);
//	b.title_lh(b.root_title);
//	cout << endl;
//	b.print_price_lh();
//	cout << endl;
//	b.print_title_lh();
...
////}
////else {
////	//cart main daalne k baad user jb buy krega tou stock main se minus krayengay quantity.
////}
//
//
//
...
//     FINAL PROJECT AFTER COMBINING WTH RAYYAN'S CODE
